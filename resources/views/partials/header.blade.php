...
<body>
    ...
    <header class="header-area">
        ...
        <!-- ***** Navbar Area ***** -->
        <div class="crose-main-menu mr-1">
            <div class="classy-nav-container breakpoint-off ">
                <div class="container">
                    <!-- Menu -->
                    <nav class="classy-navbar mr-2 " id="croseNav">

                        <!-- Nav brand -->
                        <a href="/" class="nav-brand"><img src=" {{asset('assets/img/rad/gma_logo.png')}}" width='80px'  alt=""></a>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Awards</a>
                                      <ul class="dropdown">
                                          ...
                                          <li><a href="{{url('category-details')}}">Category_Definition  </a></li>
