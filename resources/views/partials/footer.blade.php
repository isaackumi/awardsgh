                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            <a href="#" class="footer-logo"><img class="rounded" src="{{asset('assets/img/rad/gma_logo.png')}} " width='170px' alt=""></a>
                        ...
                        <div class="single-footer-widget mb-70">
                            ...
                            <nav class="footer-menu">
                                <ul>
                                    ...
                                    <li><a href="/#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Nominations</a></li>
                                    ...
                                    <li><a href="/#"><i class="fa fa-angle-double-right" aria-hidden="true"></i> FAQ's</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
